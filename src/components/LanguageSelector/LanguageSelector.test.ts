...
describe("LanguageSelector", () => {
  ...
  it("renders current language name on the button", () => {
    ...
    expect(wrapper.find(".language-selector__button").text()).toContain(
      "English"
    );
  });
  ...
  it("opens dropdown and renders locale options sorted by name", async () => {
    ...
    const options = wrapper.findAll(".language-selector__option");
  ...
  it("selecting Afrikaans loads translations and updates store", async () => {
    ...
    await wrapper.findAll(".language-selector__option")[0].trigger("click");
  ...
  it("selecting English skips Afrikaans lazy-load", async () => {
    ...
    await wrapper.findAll(".language-selector__option")[1].trigger("click");
  ...
  it("closes the dropdown on Escape", async () => {
    ...
    const button = wrapper.find(".language-selector__button");
